...
Singleton {
    ...
    animationCurves: QtObject {
        readonly property list<real> expressiveFastSpatial: [0, 0, 1, 1, 1, 1]
        readonly property list<real> expressiveDefaultSpatial: [0, 0, 1, 1, 1, 1]
        readonly property list<real> expressiveSlowSpatial: [0, 0, 1, 1, 1, 1]
        readonly property list<real> expressiveEffects: [0, 0, 1, 1, 1, 1]
        readonly property list<real> emphasized: [0, 0, 1, 1, 1, 1]
        readonly property list<real> emphasizedFirstHalf: [0, 0, 1, 1, 1, 1]
        readonly property list<real> emphasizedLastHalf: [0, 0, 1, 1, 1, 1]
        readonly property list<real> emphasizedAccel: [0, 0, 1, 1, 1, 1]
        readonly property list<real> emphasizedDecel: [0, 0, 1, 1, 1, 1]
        readonly property list<real> standard: [0, 0, 1, 1, 1, 1]
        readonly property list<real> standardAccel: [0, 0, 1, 1, 1, 1]
        readonly property list<real> standardDecel: [0, 0, 1, 1, 1, 1]
        readonly property real expressiveFastSpatialDuration: 0
        readonly property real expressiveDefaultSpatialDuration: 0
        readonly property real expressiveSlowSpatialDuration: 0
        readonly property real expressiveEffectsDuration: 0
    }
    ...
    animation: QtObject {
        property QtObject elementMove: QtObject {
            ...
            property list<real> bezierCurve: [0, 0, 1, 1, 1, 1]
